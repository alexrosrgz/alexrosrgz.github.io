...
Personal static site for **Alejandro Rosales Rodriguez**. Root-relative paths (`/css/…`, `/watched/…`) assume this repo is published as the user GitHub Pages site (`alexrosrgz.github.io`).
...
3. After deploy, the site is at `https://alexrosrgz.github.io/`. Watched lives at `/watched/`.
